...
int main(int argc, char* argv[]) {
    ...
    switch (exampleNum) {
    case 1:
        jet::runExample1(outputDir, targetSpacing, numberOfFrames, format, fps);
        break;
    case 2:
        jet::runExample2(outputDir, targetSpacing, numberOfFrames, format, fps);
        break;
    case 3:
        jet::runExample3(outputDir, targetSpacing, numberOfFrames, format, fps);
        break;
    default:
        std::cout << toString(parser) << '\n';
        exit(EXIT_FAILURE);
