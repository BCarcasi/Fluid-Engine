...
namespace jet {
    ...
    // between 0 and 1. If phi is less than -1.5, it will return 0. If phi
    ...
    // If phi is less than -1.5, it will return 0. If phi is greater than
    ...
    //
    // The input parameters, phi0 and phi1, are the level set values,
    ...
    // phi0 and phi1 are negative, it means the points are both inside the
